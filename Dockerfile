...
# bitsandbytes is needed for 8-bit quantization
# decord is needed for video decoding (comfy node install doesn't handle [decord] extra)
RUN comfy --workspace /comfyui node install https://github.com/MakkiShizu/ComfyUI-Qwen2_5-VL.git \
    && uv pip install accelerate bitsandbytes decord
